...
def average_recall_vs_avg_nr_proposals(ground_truth, proposals,
    ...
    pred_vid_lst = proposals['video-id'].unique()
    ...
    for videoid in video_lst:
        ...
        if videoid not in pred_vid_lst:
    ...
    pcn_lst = np.arange(1, 101) / 200.0 * (max_avg_nr_proposals * float(video_lst.shape[0]) / total_nr_proposals)
