...
class VideoDataSet(data.Dataset):  # thumos
    ...
    def __getitem__(self, index):
        ...
        if self.mode == "train":
            match_score_action,match_score_start, match_score_end, confidence_score = self._get_train_label(index)
    ...
    def _get_match_map(self):
        ...
        for jdx in range(1, self.max_duration + 1):
            ...
            a = (jdx - 1) // 2
            for i in range(a):
                tmp_match_window.append([0.1, 0.2])

            for idx in range(self.num_videoframes - a):
    ...
    def _get_train_label(self, index):
        ...
        return match_score_action,match_score_start, match_score_end, gt_iou_map
    ...
    def _get_data(self):
        ...
        for num_video, video_name in enumerate(video_name_list):
            ...
            if self.mode == 'train':
                ...
                elif num_snippet - windows_start[-1] - num_videoframes > int(skip_videoframes):
                    windows_start.append(num_snippet - num_videoframes)
